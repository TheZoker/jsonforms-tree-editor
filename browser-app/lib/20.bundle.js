...
(function (NavigatorContextMenu) {
    ...
    NavigatorContextMenu.DIFF = __spread(exports.NAVIGATOR_CONTEXT_MENU, ['5_diff']);
    NavigatorContextMenu.WORKSPACE = __spread(exports.NAVIGATOR_CONTEXT_MENU, ['6_workspace']);
    NavigatorContextMenu.ACTIONS = __spread(exports.NAVIGATOR_CONTEXT_MENU, ['7_actions']);
...
var FileNavigatorContribution = /** @class */ (function (_super) {
    ...
    FileNavigatorContribution.prototype.registerCommands = function (registry) {
        ...
        registry.registerCommand(FileNavigatorCommands.COLLAPSE_ALL, {
            execute: function () { return _this.collapseFileNavigatorTree(); },
            isEnabled: function () { return _this.workspaceService.opened; },
            isVisible: function () { return _this.workspaceService.opened; }
        });
    };
...
var FileNavigatorWidget = /** @class */ (function (_super) {
    ...
    function FileNavigatorWidget(props, model, contextMenuRenderer, commandService, selectionService, workspaceService, shell, fileSystem) {
        ...
        _this.title.iconClass = 'fa navigator-tab-icon';
