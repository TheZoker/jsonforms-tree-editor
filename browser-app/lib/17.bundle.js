...
(function (TerminalMenus) {
    ...
    TerminalMenus.TERMINAL_NAVIGATOR_CONTEXT_MENU = ['navigator-context-menu', '4_new'];
...
var TerminalFrontendContribution = /** @class */ (function () {
    ...
    TerminalFrontendContribution.prototype.activateTerminal = function (widget, options) {
        if (options === void 0) { options = { area: 'bottom' }; }
...
var TerminalWidgetImpl = /** @class */ (function (_super) {
    ...
    TerminalWidgetImpl.prototype.getCSSPropertiesFromPage = function () {
        ...
        var fontFamily = lookup(htmlElementProps, '--theia-terminal-font-family');
