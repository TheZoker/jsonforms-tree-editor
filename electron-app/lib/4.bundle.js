            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (home) {
                            tempWorkspaceFile = workspace_service_1.getTemporaryWorkspaceFileUri(new uri_1.default(home));
                        }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (!displayName.endsWith("." + workspace_service_1.THEIA_EXT) && !displayName.endsWith("." + workspace_service_1.VSCODE_EXT)) {
                            selected = selected.parent.resolve(displayName + "." + workspace_service_1.THEIA_EXT);
                        }
...
(function (WorkspaceFrontendContribution) {
    ...
    WorkspaceFrontendContribution.DEFAULT_FILE_FILTER = {
        'Theia Workspace (*.theia-workspace)': [workspace_service_1.THEIA_EXT],
        'VS Code Workspace (*.code-workspace)': [workspace_service_1.VSCODE_EXT]
    };
    /**
...
var WorkspaceService = /** @class */ (function () {
    ...
    WorkspaceService.prototype.getDefaultWorkspacePath = function () {
        ...
        if (window.location.hash.length > 1) {
            // Remove the leading #.
            var wpPath = window.location.hash.substring(1);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        stat = _a.sent();
                        return [4 /*yield*/, this.writeWorkspaceFile(stat, this._roots)];
                    case 5:
                        stat = _a.sent();
