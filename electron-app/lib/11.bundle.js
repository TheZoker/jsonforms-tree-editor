    ...
    MonacoEditorModel.prototype.fireWillSaveModel = function (reason, token) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, Promise.all(waitables).then(function (allOperations) {
                        var e_3, _a;
                        if (token.isCancellationRequested) {
                            return;
                        }
                        try {
                            for (var allOperations_1 = __values(allOperations), allOperations_1_1 = allOperations_1.next(); !allOperations_1_1.done; allOperations_1_1 = allOperations_1.next()) {
                                var operations = allOperations_1_1.value;
                            ...
                            try {
                                if (allOperations_1_1 && !allOperations_1_1.done && (_a = allOperations_1.return)) _a.call(allOperations_1);
                            }
...
/***/ "../node_modules/@theia/monaco/lib/browser/textmate/monaco-textmate-builtin-theme-provider.js":
/*!****************************************************************************************************!*\
  !*** ../node_modules/@theia/monaco/lib/browser/textmate/monaco-textmate-builtin-theme-provider.js ***!
  \****************************************************************************************************/
/*! no static exports found */
...
var core_1 = __webpack_require__(/*! @theia/core */ "../node_modules/@theia/core/lib/common/index.js");
var theming_1 = __webpack_require__(/*! @theia/core/lib/browser/theming */ "../node_modules/@theia/core/lib/browser/theming.js");
var monaco_textmate_builtin_theme_provider_1 = __webpack_require__(/*! ./monaco-textmate-builtin-theme-provider */ "../node_modules/@theia/monaco/lib/browser/textmate/monaco-textmate-builtin-theme-provider.js");
...
var MonacoTextmateService = /** @class */ (function () {
    ...
    MonacoTextmateService.prototype.initialize = function () {
        ...
        this.grammarRegistry = new vscode_textmate_1.Registry({
            ...
            theme: this.monacoThemeRegistry.getTheme(monaco_theme_registry_1.MonacoThemeRegistry.DARK_DEFAULT_THEME),
        ...
        this.themeService.onThemeChange(function (themeChange) {
            var theme = _this.monacoThemeRegistry.getTheme(themeChange.newTheme.editorTheme || monaco_theme_registry_1.MonacoThemeRegistry.DARK_DEFAULT_THEME);
            if (theme) {
                _this.grammarRegistry.setTheme(theme);
            }
        });
...
var TextmateRegistry = /** @class */ (function () {
    ...
    TextmateRegistry.prototype.registerTextmateGrammarScope = function (scope, description) {
